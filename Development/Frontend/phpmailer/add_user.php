...
if(isset($_POST['btnsubmit'])) {
    if ($_POST['emailAdmin'] == '') {
        ...
        /* generate random user name for user*/
        ...
        $mail->isHTML();
        $mail->Body = "The Username is ".$username."." ."    The  password is " . $password . ".";
        ...
        if ($mail->send()) {
            ...
            $sql = "INSERT INTO admin (username, pass, email) VALUES (' $username', '$password',' $to')";
